...
- [x] Screen-capture defences (detect screenshots → system row in chat; shield over chat / contacts / settings / QR while iOS reports recording or external display; isSecureTextEntry-wrapped QR sheet with runtime self-test + automatic fallback; optional peer-notify, default off)
